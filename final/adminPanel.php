                ...
                <article>
                    <div>
                        ...
                        <ul style="list-style:none";>
                            <li><p><strong>Add a New Member:</strong></p></li>
                            <a href="register.php">Add New Member</a>
                            <li><p><strong>Select Member Profile to Edit:</strong></p></li>
                            ...
                            <?php
                                ...
                                ?>
                                <li><p><strong>Select Member Profile to Delete:</strong></p></li>
                                <form action="adminPanel.php" method="POST">
                    ...
                    <div>
                        ...
                        <ul style="list-style:none";>
                            <li><p><strong>Add a Bulletin Post:</strong></p></li>
                            <a href="addBulletin.php">Add New Post</a>
                            <li><p><strong>Select Bulletin Post to Edit:</strong></p></li>
                            <form action="adminPanel.php" method="POST">
                            ...
                            ?>
                            <li><p><strong>Select Bulletin Post to Delete:</strong></p></li>
                            <form action="adminPanel.php" method="POST">
                    ...
                    <div>
                        <h1>Events:</h1>
                        <ul style="list-style:none";>
                            <li><p><strong>Add a New Event:</strong></p></li>
                            <a href="addEvent.php">Add an Event</a>
                            <li><p><strong>Select Event to Edit:</strong></p></li>
                            <form action="adminPanel.php" method="POST">
                            ...
                            ?>
                            <p><strong>Select Event to Delete:</strong></p>
                            <form action="adminPanel.php" method="POST">
                    ...
                    <div>
                    	<h1>Artists:</h1>
                        <ul style="list-style:none";>
                            <li><p><strong>Add a New Artist:</strong></p></li>
                            <a href="artist.php">Add an Artist</a>
                            <li><p><strong>Select Artist to Edit:</strong></p></li>
                            <form action="adminPanel.php" method="post">
                        ...
                        <?php		
                            ...
                            ?>
                            <li><p><strong>Select Artist to Delete:</strong></p></li>
                            <form action="adminPanel.php" method="POST">
