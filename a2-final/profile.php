                    ...
                    <div>
                        ...
                        <?php 
							if ($_SESSION['membership_type'] == 2) {
								echo '<a href="editProfile.php?id='. $_SESSION['id'] . '">[Edit Profile]</a>';
							} else {
								echo '<a href="editProfile.php?id='. $_SESSION['id'] . '">[Edit Profile]</a><a href="deleteProfile.php?id=' . $_SESSION['id'] . '">[Delete Profile]</a>';
