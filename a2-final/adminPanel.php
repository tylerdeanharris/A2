            ...
            <section id="main-content">
                <article>
                    <div>
                        <h1>Members:</h1>
                        <ul>
                            <li><p>Add a New Member:</p></li>
                            <a href="register.php">Add New Member</a>
                            <li><p>Select Member Profile to Edit: </p></li>
                            ...
                            <?php
                                ...
                                ?>
                                <li><p>Select Member Profile to Delete:</p></li>
                                <form action="adminPanel.php" method="POST">
                    ...
                    <div>
                        ...
                        <ul>
                            <li><p>Add a Bulletin Post:</p></li>
                            <a href="addBulletin.php">Add New Post</a>
                            <li><p>Select Bulletin Post to Edit:</p></li>
                            <form action="adminPanel.php" method="POST">
                            ...
                            ?>
                            <li><p>Select Bulletin Post to Delete:</p></li>
                            <form action="adminPanel.php" method="POST">
                    ...
                    <div>
                        <h1>Events:</h1>
                        <ul>
                            <li><p>Add a New Event:</p></li>
                            <a href="addEvent.php">Add an Event</a>
                            <li><p>Select Event to Edit:</p></li>
                            <form action="adminPanel.php" method="POST">
                    ...
                    <div>
                    	<h1>Artists:</h1>
                        <ul>
                            <li><p>Add a New Artist:</p></li>
                            <a href="artist.php">Add an Artist</a>
                            <li><p>Select Artist to Edit: </p></li>
                            <form action="adminPanel.php" method="post">
                        ...
                        <?php		
                            ...
                            ?>
                            <li><p>Select Artist to Delete:</p></li>
                            <form action="adminPanel.php" method="POST">
