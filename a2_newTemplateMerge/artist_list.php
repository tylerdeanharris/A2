...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <meta name="keywords" content="Music-Townsville, Townsville music events, tcmc, Townsville Music Artists">
          ...
          <section id="main-content">
            ...
            <?php
				...
				if ($featuredResult['artist_id'] != $random) {
					...
					echo '<li><div><a href="artist_description.php?artist_id=', $featuredResult['artist_id'], '&artist_name=', $featuredResult['artist_name'], '">
					<h2 id=artistname">', $featuredResult['artist_name'], '</h2></a></div></li>';
					if($result) {
						echo "<li><div><img width='300px' height='200px' src='".$image_url."'><li></div></li>";
					} else{ 
